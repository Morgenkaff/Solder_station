...
void updateEncoder() {
  ...
  switch (active_val) {
    case 0:
      ...
      break;
    case 1:
      airgun_temp = min(500, max(0, encoderValue));
      break;
  }
...
void displayControl() {
      ...
      sprintf(tmp_char, "%03d", airgun_temp);
